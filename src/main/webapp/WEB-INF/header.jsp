...
<header>
    <nav class="nav-sec">
        ...
        <a href="http://www.cinestar.com.pe/quienes_somos">Quienes somos</a>&nbsp;&nbsp;l&nbsp;&nbsp;
        <a href="http://www.cinestar.com.pe/trabaja_con_nosotos">Trabaja con nosotros</a>&nbsp;&nbsp;l&nbsp;&nbsp;
        <a href="http://www.efact.pe/consult.html" target="_blank">Consulta tu comprobante de pago</a>&nbsp;&nbsp;l&nbsp;&nbsp;
        <a href="http://www.cinestar.com.pe/contactenos/#contenido_titulo" class="anchorLink">Contactenos</a>
    </nav>
    <div class="area-logo">
        <a href="index.jsp"><img src="img/varios/logo-cinestar.png">
        </a>
    </div>
    <nav class="menu">
        ...
        <span class="social">Siguenos en: </span>
